...
import com.viveknaskar.common.ExampleUtils;
 ...
 * }</pre>
 *
 * <p>The input file defaults to a public data set containing the text of of documentation.
 You can override it and choose your own input with {@code --inputFile}.
 */
public class WordCount {
  ...
  public interface WordCountOptions extends PipelineOptions {
     ...
     *documentation. Set this option to choose a different input file or glob.
     */
    @Description("Path of the file to read from")
    @Default.String("gs://cloud-function-gcsbucket/documentation.txt")
    String getInputFile();
